...
<<<<<<< HEAD
  ...
  LibraryBig,
  Laptop2,
  Globe // Alternative icon for Online Booking
=======
  Settings, 
  HelpCircle, 
  LogOut ,
...
<<<<<<< HEAD
  ...
  const menuItems = currentUser?.roleID === 1 ? [
    { id: 'dashboard', icon: Laptop2, label: 'Dashboard' }, 
    { id: 'People', icon: Users, label: 'People' },
    {id: 'BatchManagement', icon:Contact, label:'BatchManagement'},
    { id: 'Class', icon: CalendarDays, label: 'Class' },
    { id: 'package', icon: Package, label: 'Packages' }, 
    {id: 'InvoiceManagement', icon:CreditCard, label:'InvoiceManagement'},
...
>>>>>>> 02401165eb2726f55949e8aae6803a222b65777f
    ...
    { id: 'People', icon: Users, label: 'People' },
    {id: 'BatchManagement', icon:Contact, label:'BatchManagement'},
    { id: 'item', icon: LibraryBig, label: 'Item' }, 
    { id: 'Class', icon: CalendarCheck, label: 'Class' },
    {id: 'InvoiceManagement', icon:CreditCard, label:'InvoiceManagement'},
    { id: 'reports', icon: ClipboardList, label: 'Reports' },
  ];
